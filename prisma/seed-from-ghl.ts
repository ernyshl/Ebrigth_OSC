...
const BRANCH_BY_CODE: Record<string, string> = {
  OD:   '00 Ebright OD',
  ONL:  '01 Ebright Public Speaking (Online)',
  ST:   '02 Ebright Public Speaking (Subang Taipan)',
  SA:   '03 Ebright Public Speaking (Setia Alam)',
  SP:   '04 Ebright Public Speaking (Sri Petaling)',
  KD:   '05 Ebright Kids Public Speaking (Kota Damansara)',
  PJY:  '06 Ebright Public Speaking (Putrajaya)',
  AMP:  '07 Ebright Kids Public Speaking (Ampang)',
  CJY:  '08 Ebright Public Speaking (Cyberjaya)',
  KLG:  '09 Ebright Public Speaking (Klang)',
  DA:   '10 Ebright Kids Public Speaking (Denai Alam)',
  BBB:  '11 Ebright Public Speaking (Bandar Baru Bangi)',
  DK:   '12 Ebright Public Speaking (Danau Kota)',
  SHA:  '13 Ebright Public Speaking (Shah Alam)',
  BTHO: '14 Ebright Public Speaking (Bandar Tun Hussein Onn)',
  EGR:  '15 Ebright Public Speaking (Eco Grandeur)',
  BSP:  '16 Ebright Public Speaking (Bandar Seri Putra)',
  RBY:  '17 Ebright Public Speaking Academy (Bandar Rimbayu)',
  TSG:  '18 Ebright Public Speaking Academy (Taman Sri Gombak)',
  KW:   '19 Ebright Public Speaking Academy (Kota Warisan)',
  TTG:  '20 Ebright Public Speaking Academy (TTDI Grove)',
}
